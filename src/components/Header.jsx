    ...
    <header className="w-full py-6 px-4 md:px-8 bg-secondary/80 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center">
        <nav className="hidden md:flex items-center space-x-8 text-sm">
          <Link href="/main/shop" className="nav-link">Shop</Link>
          <Link href="/main/collections" className="nav-link">Collections</Link>
          <Link href="/main/journal" className="nav-link">Journal</Link>
        </nav>
