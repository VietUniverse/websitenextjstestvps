      ...
      <section className="text-center py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-gray-600">
            Each collection is a narrative, a carefully composed story told
            through objects of beauty and purpose.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 md:px-8 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link
            ...
            className="md:col-span-2 relative block group overflow-hidden h-[60vh] rounded-lg"
          >
            <Image
            ...
            />
            <div className="absolute inset-0 bg-black/20 group-hover:bg-opacity-40 transition-colors duration-300 flex flex-col items-center justify-center p-8 text-white text-center">
              <h2 className="text-4xl md:text-5xl font-serif">
                The Living Room Edit
              </h2>
              <p className="mt-4 max-w-md">
                Timeless furniture and decor to create a sanctuary of comfort
                and style.
              </p>
              <span className="mt-6 border-b-2 border-white pb-1 font-semibold tracking-wider">
                Explore Now
              </span>
            </div>
          </Link>
          ...
          <Link
            ...
            className="relative block group overflow-hidden h-[60vh] rounded-lg"
          >
            <Image
            ...
            <div className="absolute inset-0 bg-black/20 group-hover:bg-opacity-40 transition-colors duration-300 flex flex-col items-center justify-center p-8 text-white text-center">
              ...
              <p className="mt-4">
                Staple pieces defined by quality fabrics and impeccable fit.
              </p>
              <span className="mt-6 border-b-2 border-white pb-1 font-semibold tracking-wider">
                Discover Style
              </span>
          ...
          >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-20 group-hover:bg-opacity-40 transition-colors duration-300 flex flex-col items-center justify-center p-8 text-white text-center">
              ...
              <p className="mt-4">
                Handcrafted pottery that brings organic texture to your table.
              </p>
              <span className="mt-6 border-b-2 border-white pb-1 font-semibold tracking-wider">
                Shop Now
              </span>
