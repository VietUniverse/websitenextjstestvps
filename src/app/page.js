...
// Component này giờ đây là một Server Component, không cần 'use client'.
// Các style và font chữ sẽ được kế thừa từ layout.js và globals.css.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="w-full h-64 md:h-96 overflow-hidden rounded-lg">
              <Image 
                ...
                width={1200}
                height={800}
                priority={true} // Ưu tiên tải ảnh này vì nó ở màn hình đầu tiên
